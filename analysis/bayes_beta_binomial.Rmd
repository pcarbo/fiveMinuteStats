...
(1-q)^{70}$ is *exactly the density of a [Beta distribution][beta]* (up
to a constant of proportionality). Specifically, it is the density of
a $\mathrm{Beta}(31, 71)$ distribution.  So the posterior distribution
for $q$ is $\mathrm{Beta}(31, 71)$, which we write as $q \mid D \sim
\mathrm{Beta}(31, 71)$.
