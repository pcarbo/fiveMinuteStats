...
In most cases, the likelihood ratio for model $M_1$ vs. model $M_0$ for
a continuous random variable $X$, given an observation $X = x$, can be
well approximated by the ratio of the model densities of $X$,
