...
qbeta(0.95,31,71)
```
So [`r round(qbeta(0.05,31,71),2)`, `r round(qbeta(0.95,31,71),2)`] is a 90% Bayesian Confidence Interval for $q$. (It is 90% because there is a 5% chance of it being below `r round(qbeta(0.05,31,71),2)` and 5% of it being above `r round(qbeta(0.95,31,71),2)`).
