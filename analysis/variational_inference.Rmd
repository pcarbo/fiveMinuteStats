...
rmarkdown::render("variational_inference.Rmd",
...
TO DO: Circle back to thinking about the iterative algorithm as an
optimization algorithm with a known objective function.
