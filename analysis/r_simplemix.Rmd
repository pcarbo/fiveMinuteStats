...
Function to compute the posterior distribution of the allele frequencies
for each population and for each locus.

```{r posterior-param-allele-frequencies}
...
```{r posterior-param-allele-frequencies-test, eval=FALSE}
set.seed(123)
sim <- r_simplemix(20,P)
