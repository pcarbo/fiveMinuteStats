...
2. Write a function, `posterior_prob_assignment(x,P,w)`, to
...
Beta(`a[1]`,`a[2]`). Because the Beta distribution has two parameters,
there will be 2 parameters for each locus and each population. So the
output of your function should be a 2 x 'K' x `R` array (where 'K=2'
because we have a mixture of 2 populations).
