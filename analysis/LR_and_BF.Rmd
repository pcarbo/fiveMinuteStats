...
[discrete data](likelihood_ratio_simple_models.html) and
[continuous data](likelihood_ratio_simple_continuous_data.html) to
compare support for two fully specified models.
...
[pdf_version]: https://github.com/pcarbo/fiveMinuteStats/blob/master/docs/LD_and_BF.pdf
