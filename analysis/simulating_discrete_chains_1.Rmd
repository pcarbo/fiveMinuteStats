...
Our function returns a vector that contains the states of our
simulated chain through time. Recall that our state space is
$\{1,2,3\}$. Below, we visualize how these chains evolve through time:
...
[pdf_version]: https://github.com/pcarbo/fiveMinuteStats/blob/master/docs/simulating_discrete_chains_1.pdf
